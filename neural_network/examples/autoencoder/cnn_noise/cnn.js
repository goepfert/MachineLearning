...
const App = (() => {
  ...
  function loadAndDrawRandomImage() {
    ...
    image = Utils.add_SP_Noise(image, sp_noise_prob);
  ...
  function predict() {
    ...
    tf.tidy(() => {
      ...
      image = Utils.add_SP_Noise(image, sp_noise_prob, 1);
  ...
  async function train() {
    ...
    const trainingData = imageDataset.getTrainingData(sp_noise_prob);
